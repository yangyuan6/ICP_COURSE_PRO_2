...
// propose to start the canister by id1
call canister.propose(variant {uninstallCode}, opt canister_id, null);
...
// propose to start the canister by id1
call canister.propose(variant {deleteCanister}, opt canister_id, null);
